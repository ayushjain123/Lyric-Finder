...
class Search extends Component {
  ...
  findTrack = (dispatch, e) => {
    ...
    axios.get(`https://cors-anywhere.herokuapp.com/track.search?q_track=${this.state.trackTitle}&page_size=10&page=1&s_track_rating=desc&apikey=${process.env.REACT_APP_MM_KEY}
    `)
    .then(res => {
      dispatch(
        {
